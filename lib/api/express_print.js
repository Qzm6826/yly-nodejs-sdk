...
class ExpressPrint {
     ...
     * @returns {*}
     */
    index(machineCode, content, originId, sandbox) {
        ...
        return this.rpcClient.call('expressprint/index', {machine_code : machineCode, content : content, origin_id : originId, sandbox : sandbox});
    }
